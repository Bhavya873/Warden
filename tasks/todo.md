...
- [x] **Checkpoint 1** — review PyO3 boundary shape (after Task 0/1/2)
- [x] **Checkpoint 2** — confirm Phase 1 ground-truth check is clean (after Task 3)
- [x] **Task 4** — Naive coordinator end-to-end (Phase 2)
- [x] **Task W0** — WS plumbing + bare canvas viewer *(parallel, needs only Task 3)* — folded into Task 8's build
- [x] **Task W1** — Naive-mode dashboard wiring *(parallel, needs Task 4)* — folded into Task 8's build
- [x] **Checkpoint 3** — lock logging/metrics schema (after Task 4)
- [x] **Task 5** — Warden mode end-to-end (Phase 3 core)
- [x] **Task 6** — Adversarial staleness test + documented finding (Phase 3 amendment)
- [x] **Checkpoint 4** — review staleness finding, decide Task 11's design (after Task 6) — most important checkpoint
